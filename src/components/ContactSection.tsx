      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Ready to discuss your project? Contact us and let's make it happen.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="bg-white dark:bg-spark-dark/80 rounded-xl shadow-md p-8 animate-fade-in opacity-0" style={{ animationDelay: '0.2s' }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button type="submit" className="w-full bg-spark-purple hover:bg-spark-purple/90 text-white">
          ...
          <div className="animate-fade-in opacity-0" style={{ animationDelay: '0.3s' }}>
            <div className="bg-gradient-to-br from-spark-purple/90 to-spark-blue/90 rounded-xl shadow-md p-8 text-white h-full">
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="font-medium text-white/80 mb-1">Email Us</p>
                    <p>contact@sparksai.in</p>
                    <p>support@sparksai.in</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="font-medium text-white/80 mb-1">Call Us</p>
                    <p>+91 98765 43210</p>
                    <p>+91 98765 43211</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <p className="font-medium text-white/80 mb-1">Location</p>
